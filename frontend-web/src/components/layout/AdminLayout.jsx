...
const NAV_ITEMS = [
    ...
    { label: 'Notifications',  path: '/admin/notifications', badge: true },
];
...
const navLink = {
    ...
    fontSize: '13px', color: '#6B6760', textDecoration: 'none',
    fontFamily: "'DM Sans', sans-serif", transition: 'background 0.15s',
};
const navLinkActive = { background: '#EDE9E3', color: '#0B0D14', fontWeight: 500 };
const main = { flex: 1, padding: '40px 48px', overflowY: 'auto', maxWidth: '1100px' };
const logoutBtn = {
